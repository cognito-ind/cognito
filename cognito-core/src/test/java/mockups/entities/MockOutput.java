...
public class MockOutput extends TestRunOutput {
	...
	public void extractOutputFieldsFromModOutput(Object modOutput) {
		...
		//breaks down the mod's output (in this case a simple String, but could be a complex object) to comparable fields.
		outputFields = new ArrayList<ComparableField>();
		outputFields.add(new ComparableField("mod_op", modOutput));
	}
}