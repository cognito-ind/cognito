...
@SystemTest(
		...
		expectedOutputSource="C:/cognito/expectedoutput/SampleEoSource.txt",
		cognitiveVerifier=MockCognitiveVerifier.class,
		moduleRunner=ModOperatorMockup.class)
@FixMethodOrder(MethodSorters.NAME_ASCENDING)
public class StandardWorkingSystemCaseWithExpectedOutputSource extends RunnableTestSet {
...
//	@Test
//	public void test_03_NullInput() {
//		
//		record.getTestRunInput().setModInput(null); // TODO Neeraj : To be handled. If Mod-Input is Null, getting NullPointerException
//	}
}